...
spawn(function()
if game:GetService("ReplicatedStorage").Assets:FindFirstChild("GUI") then
                ...
                for i, v in pairs(M) do
                        if e.Name == Mob then
                            if v.Name == Mob then
                                ...
                                v.LowerTorso.Transparency = 1
                                v.RightUpperLeg.Transparency = 1
                                v.RightLowerLeg.Transparency = 1
                                v.RightFoot.Transparency = 1
                                v.LeftUpperLeg.Transparency = 1
                                v.LeftFoot.Transparency = 1
                                v.UpperTorso.Transparency = 1
                                v.RightUpperArm.Transparency = 1
                                v.RightLowerArm.Transparency = 1
                                v.RightHand.Transparency = 1
                                v.LeftUpperArm.Transparency = 1
                                v.LeftLowerArm.Transparency = 1
                                v.LeftHand.Transparency = 1
                                v.LeftLowerLeg.Transparency = 1
                                if Mode == 1 then
                                    Tween(v.HumanoidRootPart.Position, v.HumanoidRootPart.CFrame * CFrame.new(0,45,0))
                                elseif Mode == 2 then
